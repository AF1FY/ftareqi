...
import { DriverProfileModal } from "@/app/(main)/profile/_components/DriverProfileModal";
...
export function RiderCard({
    ...
    const statusStyle = getRideRequestsStyle(
        BookingStatus[
            trip.status as keyof typeof BookingStatus
        ] as BookingStatus,
    );
    ...
    return (
        <Card className="group h-fit overflow-hidden rounded-2xl border-border bg-card/40 shadow-sm transition-all hover:shadow-md hover:shadow-athens-gray/60 gap-3 pb-0">
            ...
            <CardFooter
                className={`flex items-center justify-between gap-3 border-t bg-muted/20 ${styles.riderCardFooter}`}
            >
                <div>
                    ...
                    <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
                        ...
                        <DialogContent>
                            ...
                            <DialogFooter>
                                ...
                                <button
                                    onClick={() =>
                                        void handleCancelingRide(trip.bookingId)
                                    }
                                    disabled={isLoading}
