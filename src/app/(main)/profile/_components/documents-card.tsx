...
export default function DocumentsCard({
    ...
    const documents = [
        {
            title: "License (Front)",
            status: driver?.driverLicenseFront ? "Uploaded" : "Pending",
            image: driver?.driverLicenseFront || "",
        },
        {
            title: "License (Back)",
            status: driver?.driverLicenseBack ? "Uploaded" : "Pending",
            image: driver?.driverLicenseBack || "",
        },
    ];
        ...
        >
            ...
            {!driver ? (
                <div className="rounded-xl border border-dashed border-border p-6 text-center text-sm text-muted-foreground">
                    Driver documents will appear here once your driver details
                    are available.
                </div>
            ) : (
                    ...
                    {documents.map((doc) => (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between">
                                <p
                                    className={`font-bold text-sm ${isDark ? "text-gray-200" : "text-gray-900"}`}
                                >
                                    {doc.title}
                                </p>
                                <span
                            ...
                            {/* Document Image */}
                            <div
                                className={`aspect-3/2 rounded-lg overflow-hidden relative border transition-colors ${
                                    isDark
